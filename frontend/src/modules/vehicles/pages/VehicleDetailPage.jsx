...
import { Loader2, ArrowLeft, X, Edit3, FileText, Power, PowerOff, MapPin } from 'lucide-react';
                ...
                {isEffectivelyActive ? (
                  ...
                  <div className="w-full space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-text-dark mb-1">Your hourly rate ($)</label>
                        <input
                          type="number"
                          name="hourlyRate"
                        ...
                        <p className="mt-1 text-xs text-text-gray">
                          This is the exact amount you receive per hour. Drivers see a slightly higher rate that includes our service fee.
                        </p>
                      </div>
                    </div>
                    <div className="rounded-xl border-2 border-gray-200 p-3">
                      ...
                      />
                      {activateLatitude !== '' && activateLongitude !== '' ? (
                        <p className="mt-2 text-xs font-medium text-green-600 flex items-center gap-1">
                          <MapPin size={12} /> Pickup point set
                        </p>
                      ) : (
                        <p className="mt-2 text-xs text-text-gray italic">
                          No pickup point selected yet — interact with the map above.
                        </p>
                      )}
                    </div>
                    <button
