...
public class PaymentServiceImpl implements PaymentService {
    ...
    private static final BigDecimal OWNER_PAYOUT_PERCENTAGE = new BigDecimal("0.80");
    ...
    public CreatePaymentIntentResponse createPaymentIntent(CreatePaymentIntentCommand command) {
        ...
        BigDecimal platformFee = baseAmount.multiply(PLATFORM_FEE_PERCENTAGE).setScale(MONEY_SCALE, RoundingMode.HALF_UP);
        BigDecimal ownerPayout = baseAmount.multiply(OWNER_PAYOUT_PERCENTAGE).setScale(MONEY_SCALE, RoundingMode.HALF_UP);
